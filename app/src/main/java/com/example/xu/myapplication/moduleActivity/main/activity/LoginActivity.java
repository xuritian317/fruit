...
import static com.example.xu.myapplication.R.id.service;
...
public class LoginActivity extends AppCompatActivity {
    ...
    PowerfulEditText mPetLoginPhone;
    ...
    @OnClick({R.id.clean_password, R.id.iv_show_pwd, R.id.iv_login_back,R.id.regist})
