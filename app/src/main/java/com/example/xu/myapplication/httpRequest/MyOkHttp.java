package com.example.xu.myapplication.httpRequest;

import android.content.Context;
import android.os.Handler;
import com.example.xu.myapplication.httpRequest.body.ProgressRequestBody;
import com.example.xu.myapplication.httpRequest.body.ResponseProgressBody;
import com.example.xu.myapplication.httpRequest.response.DownloadResponseHandler;
import com.example.xu.myapplication.httpRequest.response.GsonResponseHandler;
import com.example.xu.myapplication.httpRequest.response.IResponseHandler;
        ...
        public void onResponse(Call call, final Response response) throws IOException {
            if(response.isSuccessful()) {
                ...
                try {
                    ...
                    Logger.e("onResponse saveFile fail", e.toString());
            ...
            if(response.isSuccessful()) {
                ...
                if(mResponseHandler instanceof JsonResponseHandler) {       //json回调
                    try {
                        ...
                        Logger.e("onResponse fail parse jsonobject, body=" + response_body,"");
                        mHandler.post(new Runnable() {
                            @Override
                            public void run() {
                    ...
                    mHandler.post(new Runnable() {
                        ...
                        public void run() {
                            try {
                                ...
                                Logger.e("onResponse fail parse gson, body=" + response_body, e.toString());
